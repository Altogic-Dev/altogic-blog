...
export default function CreateAnAccount() {
  return (
    <div>
      <Head>
        <title>Altogic Forum App Create an Account</title>
                  ...
                  <form action="#" method="POST" className="space-y-6">
                    <div>
                      <label
                        ...
                        className="block text-sm font-medium text-slate-700 tracking-sm"
                      >
                        Name Surname*
                      </label>
                      <div className="mt-1">
                        <input
                          ...
                          required
                          className="appearance-none block w-full p-3 text-slate-500 text-base border border-gray-300 rounded-md shadow-sm placeholder-slate-500 focus:outline-none focus:ring-purple-500 focus:border-purple-500 sm:text-sm"
                        />
                      </div>
                    </div>
