    ...
    <div className="relative">
      ...
      <div className="relative">
        ...
        >
          ...
          <input
            id={id}
            className={`appearance-none block w-full h-full px-3 py-3 text-black-500 border border-gray-300 shadow-sm placeholder-slate-500 focus:outline-none focus:ring-purple-500 focus:border-purple-500 ${
              error &&
