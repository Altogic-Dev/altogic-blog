...
export default function MyProfile({ homePage, listsPage, aboutPage }) {
  ...
  useEffect(() => {
    if (homePage) setSelectedIndex(0);
    else if (listsPage) setSelectedIndex(1);
    else if (aboutPage) setSelectedIndex(2);
  }, []);
          ...
          <div className="lg:grid lg:grid-cols-[1fr,352px] divide-x divide-gray-200 lg:-ml-8 lg:-mr-8">
            <div className="pt-8 lg:py-10 lg:px-8">
              <div className="flex items-center justify-between mb-14">
                ...
                <div className="flex items-center gap-4 relative before:hidden before:md:block before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:bg-gray-300 before:w-[1px] before:h-[30px]">
              ...
              <Tab.Group selectedIndex={selectedIndex}>
                <Tab.List className="flex items-center gap-10 h-11 border-b border-gray-300">
                  ...
                  <Tab
                    ...
                    onClick={() => router.push(`/my-profile/lists`)}
                  >
                    Lists
                  </Tab>
                  <Tab
                    ...
                    onClick={() => router.push(`/my-profile/about`)}
                  >
                    About
                  </Tab>
                </Tab.List>
