...
export default function PublicationsListImageCard({ listBox, dropdown }) {
  ...
  return (
    <div className="flex items-center gap-12 space-y-4">
      ...
      <div className="flex w-[210px] h-[150px] bg-black/20 mb-4 rounded-lg" />
    </div>
  );
}
