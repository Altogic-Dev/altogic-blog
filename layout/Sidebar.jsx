        ...
        <div className="overflow-y-visible">
          ...
          <div className="flex items-center gap-3 overflow-x-auto overflow-y-visible">
            {storiesFollows.map((storiesFollow) => (
              <div key={storiesFollow.id} className="group relative z-[5] flex w-14 h-14 flex-shrink-0">
                ...
                <div
                  className="absolute right-11 top-[100px] shadow bg-white w-24 border border-gray-200 z-10 rounded-lg hidden group-hover:block"
                >
